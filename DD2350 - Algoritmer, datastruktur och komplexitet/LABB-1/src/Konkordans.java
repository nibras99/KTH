...
public class Konkordans {
    public static void main(String[] args) throws IOException {
        ...
        // Hela text filen
        File fileKorpus = new File("/info/adk17/labb1/korpus");

        // Alla ord, ett per rad
        File fileData = new File("/afs/kth.se/home/c/a/casperj/LABB1/ut");

        // Alla hashes
        File fileHash = new File("/afs/kth.se/home/c/a/casperj/LABB1/hash");
