...
/*
Denna fil innehåller en mängd funktioner som uppdaterar matrixen som sedan även skrivs till skärmen
Anledningen till att vi har olika funktioner är beroende på vilken "skärm" som skall uppdateras
Dessa uppdateringar har olika storlekar och platser det skall in på, därav de olika funktionerna
*/
